...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { active: @hotel.active, address: @hotel.address, code: @hotel.code, name: @hotel.name }
    end
  ...
  test "should update hotel" do
    patch :update, id: @hotel, hotel: { active: @hotel.active, address: @hotel.address, code: @hotel.code, name: @hotel.name }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
